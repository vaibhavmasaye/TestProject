  ...
  <div class="row " style="height: 200px;">
    <div class="col-sm-12">
      ...
      <div class="row " style="padding: 50px;">
        <div class="col-sm-10">
        <h3> <s:property value="#session.fname"/> <s:property value="#session.lname"/> </h3>
          <h2>Email:-<s:property value="#session.email"/>,<br>
         <s:property value="#session.city"/>,
        <s:property value="#session.country"/> ,<br>
    Contact Numbar:-  <s:property value="#session.contact"/> 
</h2>
         </div>
        <div class="col-sm-2" >
        <form action="updateprofile">
        <s:submit class="btn btn-default btn-lg" style="background-color: #169BD5;"  value="update Profile"> </s:submit>
        </form>
        </div>
      </div>
   </div>
...
<div id="about" class="container-fluid" >
  ...
  <div class="row ">
    ...
    <div class="col-sm-10">
     <h2> <s:property value="#session.qualification"/></h2>
    </div>
  </div>
  ...
  <div class="row ">
    ...
    <div class="col-sm-10">
      <h2><s:property value="#session.Certification"/></h2>
    </div>
  </div>
  <div class="row ">
    <div class="col-sm-2">
    ...
    <div class="col-sm-10">
     <h2><s:property value="#session.Other"/></h2>
    </div>
  </div>
  </div>
</div>
...
<div id="about" class="container-fluid" >
  ...
  <div class="row ">
    ...
    <div class="col-sm-12">
      <h2><s:property value="#session.Skill"/></h2>
    </div>
  </div>
  </div>
</div>
<div id="about" class="container-fluid">
  ...
  <div class="row ">
    ...
    <div class="col-sm-10">
      <h2><s:property value="#session.JobName"/></h2>
    </div>
  </div>
  ...
  <div class="row ">
    ...
    <div class="col-sm-10">
     <h2><s:property value="#session.experience"/></h2>
    </div>
  </div>
  <div class="row ">
    <div class="col-sm-2">
    ...
    <div class="col-sm-10">
      <h2><s:property value="#session.company_Name"/></h2>
    </div>
  </div>
  </div>
</div>
