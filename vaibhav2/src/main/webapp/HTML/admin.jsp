   ...
   <body>
        <header role="banner">
            ...
            <ul class="utilities">
              ...
              <li class="logout warn"><h5><a href="login">Log Out</a></h5></li>
            </ul>
          </header>
          
          <nav role='navigation'>
            <ul class="main">
              <li class="users"><a href="adminhome">Home</a></li>
              <li class="edit"><a href="adsearch">View All User</a></li>
            </ul>
          </nav>
          
          <main role="main">
            <section class="panel important">
             <form action="adsearch">
